...
class StatesControllerTest < ActionController::TestCase
  ...
  test "should create state" do
    assert_difference('State.count') do
      post :create, state: { state_abbreviation: @state.state_abbreviation, state_name: @state.state_name, user_id: @state.user_id }
    end
  ...
  test "should update state" do
    patch :update, id: @state, state: { state_abbreviation: @state.state_abbreviation, state_name: @state.state_name, user_id: @state.user_id }
    assert_redirected_to state_path(assigns(:state))
  end
