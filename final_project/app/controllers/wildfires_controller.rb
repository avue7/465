class WildfiresController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @wildfire.save
        ...
        format.json { render :show, status: :created, location: @wildfire }
      else
  ...
  def update
    respond_to do |format|
      if @wildfire.update(wildfire_params)
        ...
        format.json { render :show, status: :ok, location: @wildfire }
      else
  ...
  def destroy
    @wildfire.destroy
    respond_to do |format|
      format.html { redirect_to wildfires_url, notice: 'Wildfire was successfully destroyed.' }
  ...
  private
    ...
    def wildfire_params
      params.require(:wildfire).permit(:burnt_acreage, :year, :state_id)
    end
end
